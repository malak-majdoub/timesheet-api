...
def test_create_timesheet_entry(client, test_employee, test_project, auth_headers_employee):
...
def test_get_my_entries(client, test_employee, test_project, auth_headers_employee):
...
def test_manager_can_view_team_entries(client, test_manager, test_employee, test_project, auth_headers_manager, auth_headers_employee):
...
def test_update_own_entry(client, test_employee, test_project, auth_headers_employee):
...
def test_delete_own_entry(client, test_employee, test_project, auth_headers_employee):
...
def test_cannot_create_entry_with_invalid_hours(client, test_project, auth_headers_employee):
